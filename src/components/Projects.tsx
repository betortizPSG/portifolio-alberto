...
export default function Projects() {
  const projects = [
    {
      title: "Search Git",
      description: "Aplicação que consome a API do GitHub e retorna os dados do usuário pesquisado.",
      image: search2,
        ...
        <div className="container mx-auto max-w-4xl p-4 py-12">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            {projects.map((project, index) => (
              <div
                key={index}
                className={`group relative h-52 cursor-default rounded-lg m-6 p-6 ${project.colSpan} bg-cover bg-center`}
