    ...
    <section className="container mx-auto my-4 max-w-5xl p-4">
      <div className="relative p-4 text-center">
        ...
        <p className="relative text-sm text-gray-600">
          Tenho vários projetos executados e gostaria que o próximo seja o
          seu.
        </p>
      ...
      <div className="mx-auto mt-20 max-w-xl">
        <div className="relative w-full rounded-lg bg-blue-100 p-4 ps-20 md:h-64 md:ps-48">
                ...
                <tr>
                  ...
                  <td>
                    <a
                      ...
                      className="underline hover:text-blue-800"
                    >
                      alberto.ortiz.medeiros@gmail.com
                    </a>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <a
                      href="https://goo.gl/maps/ufkaiVAieN5GNmov6"
                      target="_blank"
                      className="underline hover:text-blue-800"
                    >
                      Campo Grande - MS
          ...
          <div className="absolute -left-2 -top-4 h-24 w-20 rounded-lg bg-gray-600 bg-[url('assets/foto-alberto.jpeg')] bg-cover bg-center md:-left-12 md:-top-12 md:h-72 md:w-56"></div>
        </div>
      </div>
    </section>
  )
