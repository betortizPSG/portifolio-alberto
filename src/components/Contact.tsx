...
export default function Contact() {
  ...
  const form = useRef<HTMLFormElement>(null);// Para acessar o formulário de contato
  ...
  const contacts = [
    {
      name: 'WhatsApp',
      description: '+55 67 99351-1414',
      icon: <FaWhatsapp className='h-10 w-10' />,
    },
    {
      name: 'Email',
      description: 'alberto.ortiz.medeiros@gmail.com',
      link: 'mailto:alberto.ortiz.medeiros@gmail.com?subject=Olá...',
      icon: <HiOutlineEnvelope className='h-10 w-10' />,
    },
    {
      name: 'Campo Grande - MS',
      description: 'Vila Margarida, 1188',
