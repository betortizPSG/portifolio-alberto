...
export default function Skills() {
  const educations = [
    {
      name: "Ciência da Computação | Anhanguera Educacional - Uniderp",
    },
    {
      name: "MBA Gestão de Projetos | Unopar",
    },
    {
      name: "Análise, Projeto e Gerencia de Sistemas | Unopar",
    },
    {
  ...
  const skills = [
    ...
    {
      name: "MongoDB",
      icon: "images/mongoDB2.png",
      level: 40,
    },
    {
      name: "Redux.js",
      icon: "images/redux-logo.svg",
      level: 40,
    },
  ]
